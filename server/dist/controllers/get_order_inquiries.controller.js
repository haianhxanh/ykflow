...
exports.get_order_inquiries = void 0;
const dotenv_1 = __importDefault(require("dotenv"));
const inquiry_model_1 = __importDefault(require("../model/inquiry.model"));
dotenv_1.default.config();
/*-------------------------------------GET INQUIRIES FROM DATABASE------------------------------------------------*/
const get_order_inquiries = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const data = yield inquiry_model_1.default.findAll({
...
exports.get_order_inquiries = get_order_inquiries;
