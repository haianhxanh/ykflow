...
const receive_inquiry = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const sendNotificationToMerchant = yield (0, notification_1.sendNotification)(notificationSubject, req.body.order_contact, message, null, MANDRILL_MESSAGE_FROM_EMAIL, undefined, true);
