...
export type DeliveryNoteBasis = "shopify" | "invoice";

export const mapOrderToDeliveryNote = (order: any, basis: DeliveryNoteBasis = "shopify"): DeliveryNote => {
  ...
  const lines: DeliveryNoteLine[] = (order.lineItems?.edges ?? [])
...
export const deliveryNoteFilename = (orderName: string) =>
...
export const buildDeliveryNotePdf = (note: DeliveryNote): Promise<Buffer> =>
